...
<html>
	...
	<body>
			<div class="container">
				<div class="navigation">
					<ul>
						...
						<li>
							<a href="Dashboard_Admin_Password.php">
			...
			<?php
				...
				{
					 if($_REQUEST['table_name']=="" || $_REQUEST['id']=="" || $_REQUEST['npwd']=="" || $_REQUEST['rpwd']=="" )
					{
						echo "<script>alert('Please Fill all Details');</script>";
					}
				
				
					if(isset($_REQUEST['table_name']) && isset($_REQUEST['id']) && isset($_REQUEST['npwd']) && isset($_REQUEST['rpwd']))
					{
						...
						if($npwd==$rpwd)
						{
							...
							if($tname=='seller_tb')
								$sql1="update $tname set password='$npwd' where s_id=$id";
							
							else
								$sql1="update $tname set password='$npwd' where c_id=$id";
